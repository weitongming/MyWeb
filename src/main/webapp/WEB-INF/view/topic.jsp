			...
			<div class="topic-root">
				<div class="topic-root-wrap">
					<c:forEach items="${topicList}" var="topic">
                        <a href="topic/${topic.tid}-1">${topic.name}</a>
                    </c:forEach>
                        ...
                        <c:choose>
                            <c:when test="${status.count%2!=0}">
                                <div class="topic-odd relative">
                                    <a href="topic/${topic.tid}-1" class="topic-image"><img src="${topic.image}"></a>
                                    <div class="topic-content">
                                        <a href="topic/${topic.tid}-1" class="topic-name">${topic.name}</a>
                                        <a href="topic/${topic.tid}-1" class="topic-desc">${topic.content}</a>
                                    </div>
                                </div>
                            </c:when>
                            <c:otherwise>
