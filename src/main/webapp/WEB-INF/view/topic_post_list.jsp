    ...
    <div class="main-left">
        ...
        <div class="post">
            <div class="post-wrap">
                ...
                <%--分页导航--%>
                <nav class="col-md-10 col-md-offset-3">
                    <ul class="pagination pagination-sm">
                        <%--首页--%>
                        <li><a href="topic/${type}-1">首页</a></li>
                        <%--上一页--%>
                        <c:choose>
                            <c:when test="${pageBean.curPage!=1 }">
                                <li><a href="topic/${type}-${pageBean.curPage-1 }"><span>&laquo;</span></a>
                                </li>
                            </c:when>
                            <c:otherwise>
                        ...
                        <c:choose>
                            <c:when test="${pageBean.allPage<=10 }">
                                <c:forEach begin="1" end="${ pageBean.allPage}" var="i">
                                    <li class="pageNum"><a href="topic/${type}-${i }">${i }</a></li>
                                </c:forEach>
                            </c:when>
                        ...
                        <c:choose>
                            <c:when test="${pageBean.curPage!=pageBean.allPage }">
                                <li><a href="topic/${type}-${pageBean.curPage+1 }"><span>&raquo;</span></a>
                                </li>
                            </c:when>
                            <c:otherwise>
                        ...
                        <%--尾页--%>
                        <li><a href="topic/${type}-${pageBean.allPage}">尾页</a></li>
                    </ul>
                </nav>
